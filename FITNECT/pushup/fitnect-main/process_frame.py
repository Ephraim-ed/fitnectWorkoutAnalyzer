    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            # Camera is aligned properly.
                ...
                draw_dotted_line(frame, left_hip_coord, start=hip_coord[1]-80, end=hip_coord[1]+20, line_color=self.COLORS['red'])




                knee_vertical_angle = find_angle(hip_coord, np.array([left_knee_coord[0], 0]), right_knee_coord)
