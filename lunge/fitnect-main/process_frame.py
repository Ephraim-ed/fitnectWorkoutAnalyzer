...
class ProcessFrame:
    ...
    def __init__(self, thresholds, flip_frame = False):
        ...
        self.FEEDBACK_ID_MAP = {
                                0: ('RAISE YOUR THIGH HIGHER', 150, (0, 153, 255)),
                                1: ('LOWER YOUR THIGH', 181, (0, 153, 255)),
                                2: ('CORRECT', 160, 170, (255, 80, 80)),
                                3: ('OVER RAISE', 181, (255, 80, 80))
                               }
        ...
        if keypoints.pose_landmarks:
            ...
            if offset_angle > self.thresholds['OFFSET_THRESH']:
                ...
                if display_inactivity:
                    cv2.putText(frame, 'Resetting LUNGE_COUNT due to inactivity', (10, frame_height - 90), self.font, 0.5, self.COLORS['blue'], 2, lineType=self.linetype)
                ...
                draw_text(
                    frame, 
                    "CORRECT: " + str(self.state_tracker['LUNGE_COUNT']), 
                ...
                draw_text(
                    frame, 
                    "INCORRECT: " + str(self.state_tracker['IMPROPER_LUNGE']), 
            ...
            # Camera is aligned properly.
                ...
                # -------------------------------------- PERFORM FEEDBACK ACTIONS --------------------------------------
                    ...
                    #if (left_ankle_vertical_angle > self.thresholds['ANKLE_THRESH']):
            ...
            if self.state_tracker['INACTIVE_TIME'] >= self.thresholds['INACTIVE_THRESH']:
                self.state_tracker['LUNGE_COUNT'] = 0
                self.state_tracker['IMPROPER_LUNGE'] = 0
                cv2.putText(frame, 'Resetting LUNGE_COUNT due to inactivity!!!', (10, frame_height - 25), self.font, 0.7, self.COLORS['blue'], 2)
                display_inactivity = True
